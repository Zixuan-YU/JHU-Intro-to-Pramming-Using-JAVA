...
* Module4 Program1: Calendar
* This program will prompt the user to enter a month (1-12) and a 4-digit year
...
import java.time.*;
import java.time.DayOfWeek; // Method to get the day of the week
...
public class CalendarPrint
{
    public static void main( String [] args )
    {
        ...
        // int d = 0;      // value for ...
        int m = 0;      // value for the month (1-12)
        int y = 0;      // value for the year (4-digit year number)
        int d = 1;      // value for the day in the month
        // Use a Scanner to input integer values
        Scanner input = new Scanner( System.in );
        System.out.println( "\n\n" );
        System.out.print( "Enter 4-digit year number: " );
        y = input.nextInt();     // Input the 4-digit year number, e.g. 2012
        System.out.print( "Enter the month using integer numbers from 1-12: " );
        m = input.nextInt(); // Input the month 
    ...
    {   
        ...
        printMonthBody(m, y);  // Invoke the method to print calendar body
    }
    ...
    public static void printMonthHeader( int m, int y)
    {
        ...
        System.out.print(String.format("%1$28s", monthname + "  " + y));
        System.out.print("-----------------------------");
